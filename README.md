...
- **SDK version used in this repo**
  - `io.truemetrics:truemetricssdk:1.5.0`
- **SDK Maven artifacts (GitHub-backed Maven repo)**
  - https://github.com/TRUE-Metrics-io/truemetrics_android_SDK_p_maven/tree/main/io/truemetrics/truemetricssdk/1.5.0
...
- `src/TrueMetricsSdk.Binding/`  
  Xamarin **binding project** for the vendor TrueMetrics Android SDK (**1.5.0**).
